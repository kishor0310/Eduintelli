    ...
    <div className="space-y-12 max-w-6xl mx-auto py-4 px-4 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="space-y-4">
          <Card className="p-5 border border-slate-800 bg-slate-900/90 space-y-4">
            ...
            <div className="space-y-3.5 text-xs">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-[10px] uppercase font-bold text-slate-400">Email Academic Advisory</div>
                  <div className="text-slate-200 font-semibold mt-0.5">support@eduintelli.edu</div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-[10px] uppercase font-bold text-slate-400">Advisory Helpline</div>
                  <div className="text-slate-200 font-semibold mt-0.5">+1 (800) 456-INTEL</div>
                  <div className="text-[11px] text-slate-400">Mon - Fri: 8:00 AM - 6:00 PM EST</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-[10px] uppercase font-bold text-slate-400">Campus Headquarters</div>
                  <div className="text-slate-200 font-semibold mt-0.5">Academic Complex, Block 4</div>
                  <div className="text-[11px] text-slate-400">Dean of Academic Affairs & QA</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-[10px] uppercase font-bold text-slate-400">Walk-in Office Hours</div>
                  <div className="text-slate-200 font-semibold mt-0.5">Monday – Friday</div>
                  <div className="text-[11px] text-slate-400">10:00 AM – 4:00 PM</div>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-4 border border-emerald-500/30 bg-emerald-950/20 text-xs space-y-2">
        ...
        <Card className="lg:col-span-2 p-6 border border-slate-800 bg-slate-900/80 space-y-5">
          <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:border-brand-500"
                  required
                />
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-700 text-white focus:outline-none focus:border-brand-500"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:border-brand-500 resize-none"
                required
              />
            </div>
        ...
        <div className="space-y-3 max-w-4xl mx-auto">
          {FAQS.map((faq, idx) => {
            ...
            return (
              <Card
                key={idx}
                className="p-4 border border-slate-800 bg-slate-900/80 cursor-pointer transition-all hover:border-slate-700"
              ...
              >
                ...
                {isOpen && (
                  <div className="mt-3 pt-3 border-t border-slate-800 text-xs text-slate-300 leading-relaxed animate-in fade-in">
                    {faq.answer}
                  </div>
                )}
              </Card>
