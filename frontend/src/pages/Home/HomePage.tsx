...
export const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-24 py-8 lg:py-16 px-4 lg:px-8 max-w-7xl mx-auto">
      {/* 1. HERO SECTION */}
      <section className="text-center space-y-6 pt-4 lg:pt-8 max-w-4xl mx-auto">
        ...
        <div className="pt-4 flex items-center justify-center gap-2 text-xs text-slate-400">
          ...
          <span>100% Interactive Demo Data with 21 seeded students, multi-factor risk engine & PDF reports.</span>
        </div>
      </section>

      {/* 2. STATS COUNTER */}
      <section className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
        <Card className="text-center p-6 bg-gradient-to-b from-slate-900/90 to-slate-950 border border-slate-800">
          <div className="text-4xl font-extrabold text-white mb-1">95%</div>
          <div className="text-xs font-bold uppercase tracking-wider text-brand-400">Academic Visibility</div>
          <p className="text-xs text-slate-400 mt-2">Unified intelligence layer eliminating fragmented data silos across classes.</p>
        </Card>

        <Card className="text-center p-6 bg-gradient-to-b from-slate-900/90 to-slate-950 border border-purple-500/30 shadow-ai-glow">
          <div className="text-4xl font-extrabold text-purple-300 mb-1">87%</div>
          <div className="text-xs font-bold uppercase tracking-wider text-purple-400">Early Risk Detection</div>
          <p className="text-xs text-slate-400 mt-2">Predictive trajectory warning students and faculty weeks prior to examination failure.</p>
        </Card>

        <Card className="text-center p-6 bg-gradient-to-b from-slate-900/90 to-slate-950 border border-slate-800">
          <div className="text-4xl font-extrabold text-emerald-400 mb-1">3x</div>
          <div className="text-xs font-bold uppercase tracking-wider text-emerald-400">Faster Intervention</div>
          <p className="text-xs text-slate-400 mt-2">Actionable 1-click teacher mentoring workflows that prevent course dropouts.</p>
        </Card>
      </section>
      ...
      <section id="how-it-works" className="space-y-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3 text-left">
          {[
            ...
            <Card
              key={i}
              className="p-5 relative bg-slate-900/90 border border-slate-800 flex flex-col justify-between hover:border-slate-700 transition-colors"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <div className="p-2 rounded-xl bg-slate-800 border border-slate-700">{card.icon}</div>
      ...
      <section id="ai-engine" className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          ...
          <Card className="border border-purple-500/40 bg-gradient-to-br from-slate-900 via-slate-900/90 to-purple-950/40 shadow-2xl p-6 relative overflow-hidden">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h4 className="font-extrabold text-sm text-white">AI Academic Diagnostic</h4>
                  <p className="text-[11px] text-slate-400">Student: Jordan Hayes (CS2023-002)</p>
                </div>
              </div>
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="p-4 rounded-2xl glass-card border border-slate-800 space-y-1">
              <h4 className="font-bold text-sm text-white flex items-center gap-2">
                ...
                <span>Zero-Latency Heuristic + LLM Hybrid</span>
              </h4>
              <p className="text-slate-400 leading-relaxed">
                Works instantly offline with deterministic statistical accuracy, while optionally synthesizing qualitative narratives via Google Gemini.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Student Card */}
          <Card className="p-6 border border-slate-800 bg-slate-900/80 flex flex-col justify-between hover:border-emerald-500/50 transition-all">
            <div>
              <div className="p-3 rounded-2xl bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 inline-block mb-3">
              ...
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
                  <span>Interactive Risk Gauge & Diagnostics</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
          ...
          {/* Teacher Card */}
          <Card className="p-6 border border-purple-500/30 bg-slate-900/80 flex flex-col justify-between shadow-ai-glow hover:border-purple-400 transition-all">
            <div>
              <div className="p-3 rounded-2xl bg-purple-500/20 text-purple-400 border border-purple-500/30 inline-block mb-3">
                <Users className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-white mb-1">Teacher Portal</h3>
              <p className="text-xs text-slate-400 mb-4">
          ...
          {/* Admin Card */}
          <Card className="p-6 border border-slate-800 bg-slate-900/80 flex flex-col justify-between hover:border-sky-500/50 transition-all">
            <div>
              <div className="p-3 rounded-2xl bg-sky-500/15 text-sky-400 border border-sky-500/30 inline-block mb-3">
                <Shield className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-white mb-1">Administrator Portal</h3>
              <p className="text-xs text-slate-400 mb-4">
      ...
      {/* 6. BOTTOM BANNER */}
      <Card className="p-8 lg:p-12 text-center bg-gradient-to-r from-brand-900/40 via-purple-900/40 to-slate-900 border border-purple-500/30 shadow-2xl relative overflow-hidden">
